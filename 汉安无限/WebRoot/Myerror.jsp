...
<TABLE cellSpacing=0 cellPadding=0 width=540 align=center border=0>
  ...
  <TR>
    <TD vAlign=top height=270>
      <DIV align=center><BR><IMG height=211 src="images/error/error.gif" 
      width=329><BR><BR>
...
width=7></TD>
          <TD background=images/error/bg.gif>
            ...
            href="getindexMsg.action">返回首页</A>　 　|　　 <A 
            href="javascript:history.go(-1)">返回出错页</A>　 　|　　 <A 
            href="getindexMsg.action">关闭本页</A></FONT> </DIV></TD>
          <TD width=7><IMG 
      src="images/error/right.gif"></TD></TR></TBODY></TABLE></CENTER></TD></TR></TBODY></TABLE>
<P align=center>　</P>
<P align=center>　</P>
  </body>
</html>
