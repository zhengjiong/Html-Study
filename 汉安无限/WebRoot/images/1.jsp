...
<%}%>
	...
	<body>
		...
		<ul id="tablist">
			<li>
				<a href="http://www.baidu.com" class="current"
		...
		<DIV id="tabcontentcontainer">
			...
			<div id="menu4" class="tabcontent">
				<ul>
					...
					<li>更新记录</li>
						<ol>
							<li>2008.05.16&nbsp;删除循环获取系统相关属性功能,原因见bug - 骑士</li>
							<li>2008.05.16&nbsp;增加对指定目录跳转功能,修改需在文件中指定文件名的操作,自动获取 - 骑士</li>
							<li>2008.05.15&nbsp;增加对浏览目录指定打包功能,增加删除目录功能 - 骑士</li>
							<li>2007.12.27&nbsp;增加登录验证功能 - 骑士</li>
							<li>2007.12.26&nbsp;修改程序部分不推荐使用的方法,增加系统基本属性查看功能,部分代码重写 - 骑士</li>
